...
struct Piece {
	...
	void print() {
		switch(name) {
			...
			case pieceName::PAWN:	(color != pieceColor::WHITE) ? std::cout << "PW" : std::cout << "PB";	break;
			case pieceName::ROOK:	(color != pieceColor::WHITE) ? std::cout << "RW" : std::cout << "RB";	break;
			case pieceName::BISHOP:	(color != pieceColor::WHITE) ? std::cout << "BW" : std::cout << "BB";	break;
			case pieceName::KNIGHT:	(color != pieceColor::WHITE) ? std::cout << "NW" : std::cout << "NB";	break;
			case pieceName::KING:	(color != pieceColor::WHITE) ? std::cout << "KW" : std::cout << "KB";	break;
			case pieceName::QUEEN:	(color != pieceColor::WHITE) ? std::cout << "QW" : std::cout << "QB";	break;
